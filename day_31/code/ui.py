...
class UI:
    ...
    def _set_v_button(self):
        ...
        """
        self._v_button = ttk.Button(self._window, text="✅", command=self.v_btn_command)
    ...
    def _set_x_button(self):
        ...
        Creates and configures the ❌ button with a command callback.
        """
        self._x_button = ttk.Button(self._window, text="❌", command=self.x_btn_command)
    ...
    def flip_card(self):
        ...
        if self._card["text"] == "Hello":
            self._card.config(text="안녕하세요", bg="yellow", fg="black")
        else:
            self._card.config(text="Hello", bg="white", fg="black")
